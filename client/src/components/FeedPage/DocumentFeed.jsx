...
class DocoumentFeed extends Component {
  constructor(props) {
    super(props);
    this.state = {
      flagRequest: false,
        ...
        <div className='media-content'>
          <div className='content'>
            ...
            <p>
              ...
              <br />
              <strong>
                <Link to={`/courses/${this.props.feed.course_id}/docs/${this.props.feed.doc_id}`}>{this.props.header}</Link>
              </strong>
              <br />
